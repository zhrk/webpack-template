...
**prettier** - предполагаю что он нужен чтобы чинить через командую строку при CI, но при локальной разработке такая ситуации чаще всего не будет актуальной, вообщем нужно решать по мере поступления проблемы, т.к. и без него все работает как надо.
